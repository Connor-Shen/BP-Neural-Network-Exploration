...
class NeuralNetwork:
    ...
    # 对神经网络的参数进行初始化
    def __init__(self, innodes, hid1nodes, hid2nodes, outnodes, learningrate,):  # 用于类的初始值的设定
    ...
    def train(self, inputs, targets):
        ...
        final_outputs = (softmax(final_inputs))  # (10*1)
...
n = NeuralNetwork(innodes, hid1nodes, hid2nodes, outnodes, learningrate)
